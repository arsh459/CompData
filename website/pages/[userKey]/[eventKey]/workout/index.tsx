...
const WorkoutPage: React.FC<Props> = ({ userKey }) => {
  // console.log("q", query);
  ...
  return (
    <DefaultLayout
      title={"SocialBoat - Workouts at SocialBoat"}
      description={"Fitness app for your community. Workout section"}
      link={`https://socialboat.live/sbUser/team/workout`}
      canonical={`https://socialboat.live/sbUser/team/workout`}
      noIndex={false}
      img={homeSEO.img}
    >
