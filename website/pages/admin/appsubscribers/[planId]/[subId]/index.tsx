...
import AppSubDashboard from "@templates/AppSubTemplate";
...
const AppSubPage: React.FC<Props> = ({ planId, subId }) => {
  ...
  return (
    ...
    >
      {authStatus === "PENDING" ? (
        ...
        <AppSubDashboard planId={planId} subId={subId} />
      ) : (
        //
        <div className="flex justify-center items-center text-4xl font-bold h-screen">
          {authStatus === "FAILED" ||
