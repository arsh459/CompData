...
import SalesPatientTemplate from "@templates/PatientTemplate/SalesPatientsTemplate";
...
const SalesPatients: React.FC<Props> = ({}) => {
  ...
  return (
    <DefaultLayout
      ...
      link={"https://socialboat.live/admin/leads/rolling"}
      canonical={"https://socialboat.live/admin/leads/rolling"}
      siteName="SocialBoat"
      noIndex={true}
    ...
    >
      {authStatus === "FAILED" ? (
        ...
        <SalesPatientTemplate userObj={user} onSignOut={signOut} />
