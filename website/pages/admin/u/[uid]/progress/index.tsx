...
import UserDaily from "@modules/UserDaily/UserDaily";
...
const UserProgress: React.FC<Props> = ({ remoteUser }) => {
  ...
  return (
    <DefaultLayout
      ...
      link={`https://${homeDomain}/admin/u/${remoteUser?.uid}/progress`}
      canonical={`https://${homeDomain}/admin/u/${remoteUser?.uid}/progress`}
      img={boatsSEO.img}
      noIndex={true}
