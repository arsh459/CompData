...
import SprintsTemplate from "@templates/RewardsTemplate/SprintsTemplate";

interface Props {
  gameId: string;
}

const Benefits: React.FC<Props> = ({ gameId }) => {
  ...
  return (
    <DefaultLayout
      title="Admin"
      link={`https://${homeDomain}/admin/games/${gameId}/sprintdetails`}
      canonical={`https://${homeDomain}/admin/games/${gameId}/sprintdetails`}
      img={boatsSEO.img}
      noIndex={true}
