...
import BenefitsTemplate from "@templates/RewardsTemplate/BenefitsTemplate";
...
const Benefits: React.FC<Props> = ({ gameId }) => {
  ...
  return (
    <DefaultLayout
      title="Admin"
      link={`https://${homeDomain}/admin/games/${gameId}/benefits`}
      canonical={`https://${homeDomain}/admin/games/${gameId}/benefits`}
      img={boatsSEO.img}
      noIndex={true}
    ...
    >
      {authStatus === "PENDING" ? (
        ...
        <BenefitsTemplate gameId={gameId} />
      ) : (
        //
        <div className="flex justify-center items-center text-4xl font-bold h-screen">
          {authStatus === "FAILED" ||
