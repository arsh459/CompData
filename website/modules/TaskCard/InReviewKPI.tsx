...
const InReviewKPI: React.FC<Props> = ({
  //   earnedFp,
    ...
    <>
      <div
        className={clsx(
          ...
          overlay ? "bg-gradient-to-t from-yellow-500 to-yellow-800" : ""
        )}
        // style={{
        //   background: overlay
        ...
        // }}
      >
        <div className="absolute inset-0 justify-center items-center flex flex-col z-50">
