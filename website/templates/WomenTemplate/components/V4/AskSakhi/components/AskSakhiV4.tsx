...
import { section4colors, section4data } from "@templates/SakhiExplainer/uttils/constants";
import { Section4DataType } from "@templates/SakhiExplainer/uttils/interface";

const AskSakhiV4 = () => {
  return (
    <div className="snap-center h-screen flex flex-col justify-center items-center gap-8 overflow-hidden">
      <p
