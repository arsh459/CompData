import { period, viewTypes } from "@hooks/community/v2/useCommunityParamsV3";
import { CoachRank, UserRank } from "@models/Activities/Activity";
import { format } from "date-fns";

export const getRankHeading = (type: "player" | "team", period?: period) => {
  if (period === "week") {
...
export const getProgressParams = (
  ...
  // console.log(competitionPts, "competitionPts");
