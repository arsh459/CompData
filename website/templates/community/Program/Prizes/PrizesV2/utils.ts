...
import { Badge, badgeTypes } from "@models/Prizes/PrizeV2";
import { KPIValue } from "@models/Tasks/Task";
import { UserInterface } from "@models/User/User";
import { getLvlPtsProgress } from "@templates/community/UserProfile/utils";
...
export const getGameGoalProgress = (
  ...
  if (progress.length) {
    ...
    // console.log("avg", Math.round(avg * 100));
  }
...
const getRankPts = (
  ...
  if (
    ...
    // console.log("pts1", pts1, pts2, Math.round((pts1 / pts2) * 100));
  } else if (
    label === "monthly" &&
    sprintId &&
    rank1?.monthPointObj &&
...
export const getPtsAndProgress = (
  ...
  if (
    ...
    //   "frequency",
    //   frequency,
    //   myTeamRank?.authorName,
    //   competition?.authorName,
    //   roundId,
    //   sprintId
    // );
    return getRankPts(
