...
const PrescriptionHeader: React.FC<Props> = ({ user, createdOnText }) => {
  ...
  return (
    ...
    >
      ...
      {/* symptoms */}
      <p className="text-[#00000080] flex flex-col text-xs self-start md:pr-5  md:pt-1">
        <span className="font-popM text-black">Created on </span>
        <span className="font-popR">{createdOnText || "NA"}</span>
      </p>
    </div>
  );
};
