...
import { useAllPatients } from "@hooks/patients/useAllPatients";
...
const AllPatientsTemplate: React.FC<Props> = ({ userObj, onSignOut }) => {
  // const [filterBy, setFilterBy] = useState<"asc" | "desc">("asc");

  const { patients, nextExists, onNext } = useAllPatients(userObj.uid, "asc"); // filterBy);
...
export default AllPatientsTemplate;
