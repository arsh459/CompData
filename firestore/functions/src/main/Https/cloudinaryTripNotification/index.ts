...
import { EagerNotificationResponse } from "../cloudinaryNotification/interface";
import { getCollectionByPublicId } from "../../../models/Collection/Methods/getUtils";
import { updateOne } from "../../../utils/firestore/fetchOne";
import { getLastItem } from "../cloudinaryNotification/getLastPath";

const corsHandler = cors({ origin: true });
export const cloudinaryTripNotificationFunc = functions
  .region("asia-south1")
