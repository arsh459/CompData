...
// import { useEarnedTasksSections } from "./hooks/useEarnedTaskSections";
...
const AllFitpoints = () => {
  ...
  const { onNext, sections, init } = useEarnedTasksSectionsAlgolia(uid); //to check on dev
