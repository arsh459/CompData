    ...
    >
      ...
      {user?.currentBodyType && user?.desiredBodyType ? (
        <View className="flex flex-row justify-between p-4">
          ...
          />
          <View className="w-1/12 max-w-[30px] pb-12 flex justify-center items-center">
            <Image
              source={{
                uri: "https://ik.imagekit.io/socialboat/tr:w-100,c-maintain_ratio,fo-auto/Component_48_z2qabrZ-x.png?ik-sdk-version=javascript-1.4.3&updatedAt=1666093402160",
              }}
