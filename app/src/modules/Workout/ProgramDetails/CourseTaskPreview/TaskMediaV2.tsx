...
const TaskMediaV2: React.FC<Props> = ({
  media,
  thumbnails,
  taskName,
  uid,
  ...
  const [isPaused, _] = useState<boolean>(true);
  ...
  return (
    <>
      ...
      >
        {media ? (
          <View className="relative">
            <MediaTile mediaWidth={width} media={media} />
      ...
      {hideKPIs ? null : (
        <View className="flex flex-row justify-around    py-0.5 rounded-lg">
          <TaskPoints
