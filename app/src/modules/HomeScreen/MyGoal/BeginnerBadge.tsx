...
const colors = {
  shield: { color1: "#00375E", color2: "#001A2D", color3: "#1A193D" },
  shield_gold: { color1: "#00375E", color2: "#001A2D", color3: "#231F13" },
  shield_silver: { color1: "#00375E", color2: "#001A2D", color3: "#1D1D1D" },
  shield_bronze: { color1: "#00375E", color2: "#001A2D", color3: "#302321" },
};
interface Props {
  badgeId: badgeTypes;
  Width?: number;
...
const BeginnerBadge: React.FC<Props> = ({
  badgeId,
  athleteImage,
  brandImage,
  Width,
    ...
    >
      ...
      {brandImage ? (
        <View className="absolute left-0 right-0 top-0 bottom-0">
          <View
            className=" "
            style={{ width: Width ? Width : "100%", height: "70%" }}
          >
      ...
      {staticImg ? (
        <View className="absolute left-0 right-0 top-0 bottom-0">
          <View
            ...
            style={{ width: Width ? Width : "100%", height: "70%" }}
          >
            <Image source={{ uri: staticImg }} className="w-full h-full" />
          </View>
        </View>
      ) : null}
    </View>
