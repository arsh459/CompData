...
export const icons: { [key: string]: string } = {
  ...
  sleep:
    "https://ik.imagekit.io/socialboat/Frame%201908%20(1)_xzPuz7Ro5.png?updatedAt=1693047279966",
  weight: looseWeightIcon,
  bad_mood: boostMoodIcon,
  cycleLength: pcosPcodIcon,
